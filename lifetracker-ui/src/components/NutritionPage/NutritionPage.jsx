    ...
    if (selectedCategory) {
      ...
      if (existingToken) {
        let userInfo = await axios.post(
          "http://localhost:3001/nutrition/category",
          {
            token: existingToken,
    ...
    <div className="NutritionPage nutrition-page">
      {!userLoggedIn ? (
        ...
        <>
          ...
          {error.message || nutritions.length == 0 ? (
              ...
              <div className="css-1qfrez2">
                <div className="css-uiodal">
                  <div className="nutrition-feed">
                    ...
                    <>
                      <button onClick={handleCategoryFilter} value="">
                        {" "}
                        All Items{" "}
                      </button>
                      <button onClick={handleCategoryFilter} value="beverage">
                        {" "}
                        Beverages{" "}
                      </button>
                      <button onClick={handleCategoryFilter} value="snack">
                        {" "}
                        Snacks{" "}
                      </button>
                      <button onClick={handleCategoryFilter} value="food">
                        {" "}
                        Food{" "}
                      </button>
