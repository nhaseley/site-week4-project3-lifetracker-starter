                  ...
                  <div className="css-ebzegt">
                    <form>
                      <div className="chakra-stack css-1db3zf7">
                        ...
                        <div role="group" className="chakra-form-control css-1kxonj9">
                          <div className="chakra-input__group css-bx0blc" data-group="true">
                            <input name="imageUrl" type="text" placeholder="url for image" id="field-:rv:" className="chakra-input css-p20xy6" value=""></input>
                          </div>
                        </div>
              ...
              <div className="css-0">
                <div className="css-j7qwjs">
                  <h2 className="chakra-heading css-hzsul0">Nothing here yet.</h2>
                    ...
                    <Link to={"/nutrition/create"} className="record-nutrition-button" > Record Nutrition</Link></button>
                  <img src="https://lifetracker-ui-ai8e.onrender.com/assets/empty-fridge-a47d4d66.jpg" className="chakra-image css-ni3ua3"></img>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="css-uiodal">
          <div className="nutrition-feed">
            <div className="chakra-link button css-spn4bz">
              ...
              <button type="button" className="chakra-button css-ez23ye"> 
              <Link to={"/nutrition/create"} className="record-nutrition-button"> Add Nutrition </Link></button>
              ...
              <div className="css-2plr3x">
                <div className="css-56yjmq">
                  <span className="chakra-avatar css-en15ln">
                    <div role="img" aria-label="d" className="chakra-avatar__initials css-1ebyn6">d</div>
                  </span>
                  <div className="css-1kw2fa0">
                    <h2 className="chakra-heading css-y5314g">d<span className="chakra-badge css-lvvibp">snack</span></h2>
                  </div>
                </div>
                <div className="white css-1lekzkb">
                  <div className="chakra-stat css-1mbo1ls">
                    <dl>
                      ...
                      <dd className="chakra-stat__number css-1axeus7">10</dd>
                    </dl>
                  </div>
                  <div className="chakra-stat css-1mbo1ls">
                    <dl>
            ...
            <div className="chakra-stack css-xixnl8">
              ...
              <div className="css-2plr3x">
                <div className="css-56yjmq">
                  <span className="chakra-avatar css-en15ln">
                    <div role="img" aria-label="david" className="chakra-avatar__initials css-1ebyn6">d</div>
                  </span>
                  <div className="css-1kw2fa0">
                    <h2 className="chakra-heading css-y5314g">david
                ...
                <div className="white css-1lekzkb">
                  <div className="chakra-stat css-1mbo1ls">
                    <dl>
                      <dt className="chakra-stat__label css-14go5ty">Calories</dt>
                      <dd className="chakra-stat__number css-1axeus7">40</dd>
                    </dl>
                  </div>
                  <div className="chakra-stat css-1mbo1ls">
                    <dl>
